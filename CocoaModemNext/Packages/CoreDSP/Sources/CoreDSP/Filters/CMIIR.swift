...
//  #define samplingRate CMFs (CMIIR.c) — kept as a file-scope constant; CMFs/CMPi
//  themselves are the shared module-level declarations in CoreDSPTypes.swift.
private let samplingRate: Double = CMFs
